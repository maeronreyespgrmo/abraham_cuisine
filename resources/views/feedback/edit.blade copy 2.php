...
<div class="container mt-5">
    ...
    @include('layouts.message')
        ...
        <div class="form-group">
            ...
            <textarea class="form-control" name="other_comments" rows="5" placeholder="Enter your comments here..." required disabled>
...
If you have concerns about your data, you may contact us at [restaurant email/contact] for assistance.  
        ...
        <div class="form-group">
            ...
            {{ old('agree', $feedbacks->agree ?? '') == 'Yes' ? 'checked' : '' }} 
            disabled
            required>
