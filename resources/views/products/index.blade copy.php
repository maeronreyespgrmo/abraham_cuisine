                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="/product/{{$product_items->id}}/inactive_status" class="btn btn-secondary">Deactivate</a>
                                        @else
                                        <a href="/product/{{$product_items->id}}/active_status" class="btn btn-success">Activate</a>
                                        @endif
