...
<!-- Header part end-->
<div class="trapezoid" data-toggle="modal" data-target="#modal_banner_logo">
...
<h5 style="border: 2px solid black;" id="edit_banner_title" contenteditable="true">{{$array['banner_title']->section_text}}</h5>
<h1 style="border: 2px solid black;" id="edit_banner_sub_title" contenteditable="true">{{$array['banner_sub_title']->section_text}}</h1>
<p style="border: 2px solid black;" id="edit_banner_body" contenteditable="true">
...
<div class="col-lg-2">
<button style="  opacity: 0;width:300px;height:200px;margin-top:-300px;margin-left:-100px;position:absolute" class="btn btn-primary">Edit Image</button>
</div>
...
<h5 style="border: 2px solid black;" id="edit_about_title" contenteditable="true">{{$array['about_title']->section_text}}</h5>
<h2 style="border: 2px solid black;" id="edit_about_sub_title" contenteditable="true">{{$array['about_sub_title']->section_text}}</h2>
<p style="border: 2px solid black;" id="edit_about_body" contenteditable="true">{{$array['about_body']->section_text}}</p>
</div>
</div>
</div>
</div>
...
<div class="col-sm-8 col-lg-4">
<div class="about_text">
<h5 style="border: 2px solid black;" contenteditable="true" id="edit_history_title">{{$array['history_title']->section_text}}</h5>
<h2 style="border: 2px solid black;" contenteditable="true" id="edit_history_sub_title">{{$array['history_sub_title']->section_text}}</h2>
<h4 style="border: 2px solid black;" contenteditable="true" id="edit_history_sub_h_title">{{$array['history_sub_h_title']->section_text}}</h4>
<p style="border: 2px solid black;" contenteditable="true" id="edit_history_body">{{$array['history_body']->section_text}}</p>
</div>
</div>
</div>
</div>
...
<p style="border: 2px solid black;" id="edit_food_menu_part_title" contenteditable="true">{{$array['food_menu_part_title']->section_text}}</p>
<h2 style="border: 2px solid black;" id="edit_food_menu_part_sub_title" contenteditable="true">{{$array['food_menu_part_sub_title']->section_text}}</h2>
</div>
</div>
<div class="col-lg-6">
...
<div class="col-xl-3 col-sm-6 col-md-4" style="border: 2px solid black;">
<div class="single-footer-widget footer_2">
...
<div class="col-xl-3 col-sm-8 col-md-6"  style="padding-left: 60px; border: 2px solid black;" >
