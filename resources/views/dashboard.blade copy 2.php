...
<x-app-layout>
    ...
    <div class="container mx-auto px-4">
        ...
        <div class="table-responsive">
            <table class="display" id="reservationsTable" class="min-w-full bg-white border border-gray-200 rounded-lg shadow-lg">
                <thead>
                    <tr class="bg-gray-100 text-gray-700 uppercase text-sm leading-normal">
                        ...
                        <th class="py-3 px-6 text-left" onclick="sortTable(9)">Time Arrival</th>
                        <th class="py-3 px-6 text-left" onclick="sortTable(10)">Time Departure</th>
                        <th class="py-3 px-6 text-left" onclick="sortTable(11)">Schedule</th>
                        <th class="py-3 px-6 text-left" onclick="sortTable(12)">View Reciept</th>
                        <th class="py-3 px-6 text-left" onclick="sortTable(13)">View Order</th>
                        <th class="py-3 px-6 text-left" onclick="sortTable(14)">Status</th>
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    @foreach ($reservations as $reservation)
                        ...
                        <tr class="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td class="py-3 px-6 text-left">{{ $reservation->town_name }}</td>
                            <td class="py-3 px-6 text-left">{{ $reservation->barangay_name }}</td>
                            <td class="py-3 px-6 text-left">{{ $reservation->time_arrival }}</td>
                            <td class="py-3 px-6 text-left">{{ $reservation->time_departure }}</td>
